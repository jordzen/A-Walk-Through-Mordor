...
A walk through Mordor is a game of chance, featuring four stages of face-down cards, with one being the correct choice, allowing you to move to the next stage. Each stage adds a card, making the chance of progressing harder. The design of the cards and the game is based on JRR Tolkien's - The Lord Of The Rings. The idea is that the player starts by entering Mordor and as they progress through the stages they get closer to Mount Doom, where they will destroy the ring of power they carry. 
If the player selects the wrong card, they don't lose the game straight away. There is a pop-up that appears, showing a randomly selected enemy and a required dice roll of a D20 dice. The player then rolls the dice and if they get a higher number than required, they get another chance to select the correct card and progress. If they roll under the required number, they lose. The game is won when the player finds the correct card in the final stage. 
...
* Users want a Rules section, with an easy-to-understand set of rules for the game.
...
* Create an aesthetically pleasing game, that is simple and easy to navigate.
* To be enjoyable to play.
* Create a theme based on The Lord Of The Rings films and books.
* Include responsive feedback for user interactions with the cards and buttons.
* To have a random RNG element in the game.
...
1. Make it so that when the user selects the correct card, it will turn green and when they select the wrong card, it will turn red.
...
I love the lord of the Rings films, and they are also very popular so I decided to base the game off of them.
...
I thought it would be a cool idea to have the user start at the entrance to Mordor and the end being Mount Doom, where they destroy the
ring of power.
...
* Having a modal pop-up when the user selects the wrong cards, appearing in the center of the screen, rather than a small area in the right.
...
I have kept the color scheme relevant to the dark theme of Mordor - this being black, dark gray, and red.
This matches the theme of the game, being that you are in enemy territory, and having a color scheme keeps it aesthetically pleasing.
...
To keep the image from being disrupted by the cards and other elements, I made the color of the cards slightly transparent.
...
* Bullet points on how the game works
...
* A message describing that they have encountered an enemy and must roll a d20 dice to continue the game.
...
* When the user clicks the roll dice button, a modal will pop up showing - 
...
* The footer had 2 clickable icons that would load a new page in a separate browser. these being - 
...
These include -
  ...
  * Dice roll animation - Show the dice rolling and landing on the resulting number.

  * Create different classes for the user to select on game load, such as elf, dwarf, and man, which will affect dice roll requirements for different enemies.  

  ## **Testing Phase**

## **During Development Testing**

During the development process, I was manually tested in the following ways:-

1. Manually testing each element for appearance and responsiveness via a simulated live server in codeanywhere.
    
1. Published the page via GitHub pages shared with friends and family and asked for feedback.
...
2. Card Clickability depending on the row not working.
...
* Bug: The page is not meant to reload if the user passes the dice roll stage and clicks on the X to close the modal
...
5. Some content was not loading as intended by trying to manipulate elements using javascript.
...
All pages were tested, and no issues were found via URL or file upload.  
...
A massive thank you to David Bowers (https://github.com/dnlbowers) who has helped me a lot through my course and this project and has given me motivation when struggling.

## **Credits**

* All fonts imported from - [Google Fonts](https://fonts.google.com/)
* Icons in the footer were taken from [Font Awesome](https://fontawesome.com)
* All content was written by myself and the images are AI-generated.
